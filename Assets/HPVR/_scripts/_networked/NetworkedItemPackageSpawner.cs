...
namespace HPVR
{
    ...
    public class NetworkedItemPackageSpawner : MonoBehaviour
    {
        ...
        //-------------------------------------------------
        public void RemoveMatchingItemsFromHandStack(ItemPackage package, Hand hand)
        {
            if (hand == null)
                return;
        ...
        //-------------------------------------------------
        public void RemoveMatchingItemTypesFromHand(ItemPackage.ItemPackageType packageType, Hand hand)
        {
            for (int i = 0; i < hand.AttachedObjects.Count; i++)
            {
                ItemPackageReference packageReference = hand.AttachedObjects[i].attachedObject.GetComponent<ItemPackageReference>();
